        ...
        <div class="mt-6 bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <a href="{{ route('print.receipt.pdf', $saleId) }}"
                        class="py-3 bg-gradient-to-r from-green-600 to-gray-700 text-white rounded-xl hover:from-gray-700 hover:to-gray-800 transition-all duration-200 font-medium flex items-center justify-center gap-2 shadow-md hover:shadow-lg">
                        <i class="fas fa-print"></i>
                        Print Receipt
                    </a>
