...
<body>
    ...
    <div class="pc-container">
        <div class="md:w-[95%] mx-auto -mt-10">
            {{ $slot }}
        </div>
         <!-- SweetAlert2 JS MUST be loaded BEFORE Livewire -->
    ...
    <footer class="pc-footer">
        <div class="mx-10 footer-wrapper container-fluid">
            <div class="grid grid-cols-12 gap-1.5">
                <div class="col-span-12 my-1 sm:col-span-6">
                    <!-- Left footer content -->
                </div>
                <div class="col-span-12 my-1 sm:col-span-6 justify-self-end">
                    <p
                        class="inline-block text-purple-500 max-sm:mr-3 sm:ml-2 uppercase border p-1 font-semibold font-serif">
